...
import { Clock, ClipboardList, IndianRupee, Package, User, Bell, Utensils } from 'lucide-react';
...
const StaffDashboard = () => {
  ...
  const handleViewOrders = () => {
    navigate('/dashboard/staff/orders');
  };
  ...
  const activeOrders = recentOrders.filter(order => ['pending', 'preparing', 'ready'].includes(order.status)).length;
      ...
      >
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="mt-2 text-green-100">Manage orders for {user?.stallName || 'your stall'}</p>
          </div>
      ...
      >
        ...
        <div className="mt-4 grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <button
            ...
            className="flex items-center justify-center gap-2 bg-white text-green-600 border border-green-600 px-6 py-3 rounded-lg hover:bg-green-50 transition-colors"
          >
